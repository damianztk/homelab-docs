...
> **Skąd `100000:100000`:** pełne wyjaśnienie mechanizmu UID mapping w
> unprivileged LXC — [lxc-unprivileged-uid-mapping.md](./lxc-unprivileged-uid-mapping.md).
...
> **Where `100000:100000` comes from:** a full explanation of the UID mapping mechanism
> in unprivileged LXC — [lxc-unprivileged-uid-mapping.md](./lxc-unprivileged-uid-mapping.md).
...
> **Woher `100000:100000` stammt:** eine ausführliche Erklärung des UID-Mapping-Mechanismus
> bei unprivilegierten LXC-Containern – [lxc-unprivileged-uid-mapping.md](./lxc-unprivileged-uid-mapping.md).
